...
from config import DEFAULT_IP, SERVER3_PORT, BUFFER_SIZE
...
TCPServerSocket.bind((DEFAULT_IP, SERVER3_PORT)) # Faz o bind de endereço IP e porta
TCPServerSocket.listen() # Ativa servidor para ficar ouvindo
print("SERVIDOR 3 ATIVADO!")
