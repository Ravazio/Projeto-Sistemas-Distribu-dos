...
from config import DEFAULT_IP, SERVER4_PORT, BUFFER_SIZE
...
TCPServerSocket.bind((DEFAULT_IP, SERVER4_PORT)) # Faz o bind de endereço IP e porta
TCPServerSocket.listen() # Ativa servidor para ficar ouvindo
print("SERVIDOR 4 ATIVADO!")
