...
from config import DEFAULT_IP, SERVER1_PORT, BUFFER_SIZE
...
TCPServerSocket.bind((DEFAULT_IP, SERVER1_PORT)) # Faz o bind de endereço IP e porta
TCPServerSocket.listen() # Ativa servidor para ficar ouvindo
print("SERVIDOR 1 ATIVADO!")
